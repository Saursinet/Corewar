/*
** lldi.c for lldi.c in /home/noboud_n/rendu/CPE/Corewar/src
** 
** Made by Nyrandone Noboud-Inpeng
** Login   <noboud_n@epitech.net>
** 
** Started on  Sat Mar 21 17:06:13 2015 Nyrandone Noboud-Inpeng
** Last update Sat Mar 21 17:10:50 2015 Nyrandone Noboud-Inpeng
*/
...
int	lldi(t_list *list, t_list *elem, int line)
{
  int	i;
  int	return_value;
