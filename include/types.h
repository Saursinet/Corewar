...
** Last update Fri Apr 17 01:04:33 2015 Florian Saurs
*/
...
** arena.c
*/
void		create_arena(t_list *champs, int nbr_cycle);
...
**game.c
*/
void		start_game(t_mem *arena, t_champ *champs, int champ_count,
			   t_game xgame);
void		start_game_print(t_mem *arena, t_champ *champs,
				 int champ_count);
